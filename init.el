...
(use-package lsp-mode
  ...
  (lsp-clients-lua-language-server-main-location "/usr/share/lua-language-server/main.lua"))
...
(evil-define-key 'normal 'global (kbd "<leader>a") 'avy-goto-word-1)
...
(evil-define-key 'normal 'global (kbd "<leader>ls") #'lsp-ui-doc-mode)
...
(evil-define-key 'normal 'global (kbd "<leader>rb") 'rotate-frame-anticlockwise)
(evil-define-key 'normal 'global (kbd "<leader>rc") 'rotate-frame-clockwise)
(evil-define-key 'normal 'global (kbd "<leader>rs") 'rotate-frame)
...
(evil-define-key 'normal 'global (kbd "<down>") #'evil-next-visual-line)
(evil-define-key 'normal 'global (kbd "<up>") #'evil-previous-visual-line)
