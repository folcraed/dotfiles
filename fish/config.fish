...
function bu2
    ...
    rsync -aiv --delete --exclude='.comments/' /home/rob/Dropbox/Notebook/ /mnt/rob/Dropbox/Notebook &&
    ...
    rsync -aiv --delete --exclude='.comments/' /home/rob/Dropbox/Notebook/ /run/media/rob/Dropbox/Notebook &&
