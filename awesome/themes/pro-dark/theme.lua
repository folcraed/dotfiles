...
-- with appreciation for all the hard work - Rob
...
theme.wallpaper  = os.getenv("HOME") .. "/Dropbox/Photos/Backgrounds/robot.jpg"
...
theme.layout_termfair   = theme.icons .. "/panel/layouts/fair.png"
...
theme.tasklist_fg_focus             = "#19E31D"
